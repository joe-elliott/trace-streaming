...
//line processor/streamprocessor/traceql/expr.y:36
		{
			yylex.(*lexer).expr = newExpr(yyDollar[1].val, yyDollar[2].Selector)
		}
	case 2:
...
//line processor/streamprocessor/traceql/expr.y:53
		{
			yyVAL.Matcher = newIntOperator(yyDollar[3].integer, yyDollar[2].val, yyDollar[1].Field)
		}
	case 10:
		yyDollar = yyS[yypt-3 : yypt+1]
